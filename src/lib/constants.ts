...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: '1',
    name: 'Николай К.',
    text: 'Най-доброто бръснарско студио в града. Калин винаги прави перфектен фейд. Онлайн резервацията ми спестява толкова много време.',
    rating: 5,
    clientSince: '2022',
  },
  {
    id: '2',
    name: 'Георги М.',
    text: 'Идвам тук от 2 години. Атмосферата, уменията, вниманието към детайла — нямат равни. Горещо препоръчвам Пълното изживяване при Калин.',
    rating: 5,
    clientSince: '2023',
  },
  {
    id: '3',
    name: 'Иван П.',
    text: 'Най-после бръснарница, която уважава времето ти. Резервирах за 20 секунди, дойдох, получих най-доброто подстригване от Калин. Толкова просто.',
    rating: 5,
    clientSince: '2024',
  },
  {
    id: '4',
    name: 'Димитър С.',
    text: 'Калин превърна брадата ми от хаос в произведение на изкуството. Премиум услуга на честна цена. Това е моето място вече.',
    rating: 5,
    clientSince: '2023',
  },
];
